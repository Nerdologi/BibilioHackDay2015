...
class SingleMapController: WKInterfaceController {
	...
	override func willActivate() {
		...
		let point = CLLocationCoordinate2D(latitude: CLLocationDegrees(45.4642700), longitude: CLLocationDegrees(9.1895100))
